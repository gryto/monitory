...
class LaporanTeknis extends StatefulWidget {
  const LaporanTeknis({
    Key? key,
  }) : super(key: key);
  ...
  _LaporanTeknisState createState() => _LaporanTeknisState();
}

class _LaporanTeknisState extends State<LaporanTeknis> {
  late Widget body;
  String title = "Laporan Teknis";
