...
class LaporanKoordinasi extends StatefulWidget {
  ...
  _LaporanKoordinasiState createState() => _LaporanKoordinasiState();
}

class _LaporanKoordinasiState extends State<LaporanKoordinasi> {
  late Widget body;
  String title = "Laporan Koordinasi";
