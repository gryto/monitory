...
class DetailPenyidikan2Pidsus extends StatefulWidget {
  String accessToken, tahun, bulanAwal, bulanAkhir;
  DetailPenyidikan2Pidsus({
    Key? key,
  ...
  @override
  State<DetailPenyidikan2Pidsus> createState() =>
      _DetailPenyidikan2PidsusState();
}

class _DetailPenyidikan2PidsusState extends State<DetailPenyidikan2Pidsus> {
  late Widget body;
      ...
      return Padding(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (_, index) {
              ...
              if (selectedListLayer2 == "DILANJUTKAN KE PENUNTUTAN") {
                return GestureDetector(
                  onTap: () {},
                  child: Container(
              ...
              } else if (selectedListLayer2 == "PENYIDIKAN DIHENTIKAN") {
                return GestureDetector(
                  onTap: () {},
                  child: Container(
                    margin: const EdgeInsets.all(5.0),
