...
class DetailPenyelidikan2Pidsus extends StatefulWidget {
  String accessToken, tahun, bulanAwal, bulanAkhir;
  DetailPenyelidikan2Pidsus({
    Key? key,
  ...
  @override
  State<DetailPenyelidikan2Pidsus> createState() =>
      _DetailPenyelidikan2PidsusState();
}

class _DetailPenyelidikan2PidsusState extends State<DetailPenyelidikan2Pidsus> {
  late Widget body;
  ...
  List<String> listLayer2 = ['Dapat Ditingkatkan', 'Tidak Dapat Ditingkatkan'];
  ...
  searchData(
      tahun, bulanAwal, bulanAkhir, layer2) {
    setState(() {
      isProcess = true;
  ...
  getData(tahun, bulanAwal, bulanAkhir, layer2) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(ApiService.countPidsus3),
          headers: {
  ...
  checkSession() async {
    setState(() {
      ...
      selectedEndMonth = "12";
      selectedListLayer2 = "Dapat Ditingkatkan";
      selectedKejati = "01";
      selectedKejari = "01";
      selectedCabang = "00";
    });
      ...
      return Padding(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (_, index) {
              ...
              if (selectedListLayer2 == "Dapat Ditingkatkan") {
                return GestureDetector(
                  onTap: () {},
                  child: Container(
              ...
              } else if (selectedListLayer2 == "Tidak Dapat Ditingkatkan") {
                return GestureDetector(
                  onTap: () {},
                  child: Container(
                    margin: const EdgeInsets.all(5.0),
