...
import 'detailPenyelidikan2.dart';

class DetailPenyelidikanPidsus extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final accessToken, tahun, bulanAwal, bulanAkhir;

  const DetailPenyelidikanPidsus({
    super.key,
  ...
  @override
  State<DetailPenyelidikanPidsus> createState() =>
      _DetailPenyelidikanPidsusState();
}

class _DetailPenyelidikanPidsusState extends State<DetailPenyelidikanPidsus> {
  ...
  getData(tahun, bulanAwal, bulanAkhir) async {
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countPidsus2),
          headers: {
      ...
      if (content['status'] == 200) {
        setState(() {
          ...
          // print(listData);
          totalProses = content['data']['totalProses'];
          print(totalProses);
          totalDitingkatkan = content['data']['totalDitingkatkan'];
          totalTidakDitingkatkan = content['data']['totalTidakDitingkatkan'];
          totalDiserahkan = content['data']['totalDiserahkan'];
                              ...
                              child: ListView(
                                ...
                                children: [
                                  RoomContainer(
                                      ...
                                      title: "Total Tahap 2",
                                      colorIcon: clrWait,
                                      count: totalProses.toString()),
                                  RoomContainer(
                                      onTap: () {},
                                      title: "Pelimpahan",
                                      colorIcon: clrBadge,
                                      count: totalDitingkatkan.toString()),
                                  RoomContainer(
                                      onTap: () {},
                                      title: "Penuntutan",
                                      colorIcon: clrDelete,
                                      count: totalTidakDitingkatkan.toString()),
                                  RoomContainer(
                                      onTap: () {},
                                      title: "Penuntutan",
                                      colorIcon: clrDelete,
                                      count: totalPenyelidikan.toString()),
                                  RoomContainer(
                                      onTap: () {},
                                      title: "Penuntutan",
                                      colorIcon: clrDelete,
                                      count: totalDiserahkan.toString()),
                                ],
                              ),
                            ),
                          ],
              ...
              child: CustomButtonPrimary(
                ...
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => DetailPenyelidikan2Pidsus(
