...
class DetailEksekusi2Page extends StatefulWidget {
  ...
  @override
  State<DetailEksekusi2Page> createState() =>
      _DetailEksekusi2PageState();
}

class _DetailEksekusi2PageState extends State<DetailEksekusi2Page> {
  late Widget body;
  ...
  List<String> listLayer2 = ['p48', 'ba17', 'd3'];
  ...
  searchData(
      tahun, bulanAwal, bulanAkhir, layer2,kejati, kejari, cabang) {
    setState(() {
      isProcess = true;
  ...
  getData(tahun, bulanAwal, bulanAkhir, layer2, kejati, kejari,
      cabang) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(ApiService.countPidsusEksekusi3),
          headers: {
