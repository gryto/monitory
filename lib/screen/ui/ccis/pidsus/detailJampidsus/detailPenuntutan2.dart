...
class DetailPenuntutan2Page extends StatefulWidget {
  ...
  @override
  State<DetailPenuntutan2Page> createState() =>
      _DetailPenuntutan2PageState();
}
...
class _DetailPenuntutan2PageState extends State<DetailPenuntutan2Page> {
  ...
  List<String> listLayer2 = ['tahap2', 'pelimpahan', 'tuntutan', 'skpp'];

  List<String> listType = [
    'P16A', 'T7', 'BA5', 'BA4', 'P31', 'P32', 'P33', 'P34', 'P41', 'P42'
  ];
  ...
  searchData(
      tahun, bulanAwal, bulanAkhir, layer2, tahapan, tahapan2, kejati, kejari, cabang) {
    setState(() {
      isProcess = true;
  ...
  getData(tahun, bulanAwal, bulanAkhir, layer2, tahapan, tahapan2, kejati, kejari,
      cabang) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(ApiService.countPidsusPetut3),
          headers: {
  ...
  checkSession() async {
    setState(() {
      ...
      selectedEndMonth = "12";
      selectedListLayer2 = "tahap2";
      selectedListType = "P16A";
      selectedKejati = "01";
      selectedKejari = "02";
      selectedCabang = "00";
      selectedListJenis = "TP. CUKAI";
    });
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "No. Pengantar Tahap2 : ${row['no_pengantar_tahap2'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Tanggal Pengantar Tahap2 : ${row['tgl_pengantar_tahap2'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Tanggal Terima Tahap2 : ${row['tgl_terima_tahap2'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Jenis Lokasi Tahanan : ${row['jenis_loktahanan'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "No. Reg.Tahanan : ${row['no_reg_tahanan'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Jenis Identitas : ${row['jenis_identitas'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "No. Idetentitas : ${row['no_identitas'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Keterangan Pekerjaan : ${row['ket_pekerjaan'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Tindak Pidana : ${row['tindak_pidana'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          Text(
                            selectedListType == "P16A"
                                ? "Tanggal P16A : ${row['no_p16a'] ?? "-"}"
                                : selectedListType == "T7"
                                    ? "Tanggal T7 : ${row['no_t7'] ?? "-"}"
                                    : selectedListType == "BA4"
                                        ? "Tanggal BA4 : ${row['no_ba4'] ?? "-"}"
                                        :  "Tanggal BA5 : ${row['no_ba5'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Jumlah Barbuk : ${row['jumlah_barbuk'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Satuan Barbuk : ${row['satuan_barbuk'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Tempat Simpan Barbuk : ${row['tempat_simpan_barbuk'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Kondisi Barbuk : ${row['kondisi_barbuk'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
