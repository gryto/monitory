...
class _DetailPraPenuntutan2PageState extends State<DetailPraPenuntutan2Page> {
  ...
  List<String> listJenis = [
    'TP. KORUPSI',
    'TPPU TPPU ASAL TP. KORUPSI',
    'TP. PAJAK',
    'TPPU TPPU ASAL TP. PAJAK',
    'TP. PABEAN, TPPU TPPU ASAL TP. PABEAN',
    'TP. CUKAI',
    'TPPU TPPU ASAL TP. CUKAI'
  ];

  searchData(tahun, bulanAwal, bulanAkhir, layer2, tahapan, tahapan2, kejati,
      kejari, cabang) {
    setState(() {
      isProcess = true;
  ...
  getData(tahun, bulanAwal, bulanAkhir, layer2, tahapan, tahapan2, kejati,
      kejari, cabang) async {
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countPidsusPratu3),
          headers: {
  ...
  checkSession() async {
    setState(() {
      ...
      selectedEndMonth = "12";
      selectedListLayer2 = "berkas_lengkap";
      selectedListType = "P21A";
      selectedListJenis = "TP. PAJAK";
      selectedKejati = "00";
      selectedKejari = "00";
      selectedCabang = "00";
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Undang dan Pasal : ${row['undang_pasal'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          Text(
                            selectedListType == "P16"
                                ...
                                : selectedListType == "P17"
                                    ? "No. P17 : ${row['no_p17'] ?? "-"}"
                                    : selectedListType == "PENGEMBALIAN"
                                        ? "No. PENGEMBALIAN : ${row['no_spdp_kembali'] ?? "-"}"
                          ...
                          Text(
                            selectedListType == "P16"
                                ? "Tanggal P16 : ${row['tgl_p16'] ?? "-"}"
                                : selectedListType == "P17"
                                    ? "Tanggal P17 : ${row['tgl_p17'] ?? "-"}"
                                    : selectedListType == "PENGEMBALIAN"
                                        ? "Tanggal PENGEMBALIAN : ${row['tgl_spdp_kembali'] ?? "-"}"
                                        : selectedListType == "P18"
                                            ? "Tanggal P18 : ${row['tgl_p18'] ?? "-"}"
                                            : selectedListType == "P19"
                                                ? "Tanggal P19 : ${row['tgl_p19'] ?? "-"}"
                                                : selectedListType == "P20"
                                                    ? "Tanggal P20 : ${row['tgl_p20'] ?? "-"}"
                                                    : selectedListType == "P21"
                                                        ? "Tanggal P21 : ${row['tgl_p21'] ?? "-"}"
                                                        : "Tanggal P21A : ${row['tgl_p21a'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
