...
class PenyelidikanPidsusDetail extends StatefulWidget {
  String accessToken, tahun, bulanAwal, bulanAkhir;
  PenyelidikanPidsusDetail({
    Key? key,
  ...
  @override
  State<PenyelidikanPidsusDetail> createState() =>
      _PenyelidikanPidsusDetailState();
}

class _PenyelidikanPidsusDetailState extends State<PenyelidikanPidsusDetail> {
  late Widget body;
  ...
  searchData(tahun, bulanAwal, bulanAkhir, layer2) {
    setState(() {
      isProcess = true;
  ...
  getData(tahun, bulanAwal, bulanAkhir, layer2) async {
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countPidsus3),
          headers: {
