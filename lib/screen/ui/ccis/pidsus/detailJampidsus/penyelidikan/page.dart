...
class PenyelidikanPidsusPage extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final accessToken, tahun, bulanAwal, bulanAkhir;

  const PenyelidikanPidsusPage({
    super.key,
  ...
  @override
  State<PenyelidikanPidsusPage> createState() =>
      _PenyelidikanPidsusPageState();
}

class _PenyelidikanPidsusPageState
    extends State<PenyelidikanPidsusPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            !isProcess
                ? PenyelidikanPidsusList(data: listData)
                : const Padding(
              ...
              child: CustomButtonPrimary(
                ...
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => PenyelidikanPidsusDetail(
