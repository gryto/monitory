...
import 'detailUpayaHukum2.dart';

class DetailUpayaHukumJampidsusPage extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final accessToken, tahun, bulanAwal, bulanAkhir;

  const DetailUpayaHukumJampidsusPage({
    super.key,
  ...
  @override
  State<DetailUpayaHukumJampidsusPage> createState() =>
      _DetailUpayaHukumJampidsusPageState();
}

class _DetailUpayaHukumJampidsusPageState
    extends State<DetailUpayaHukumJampidsusPage> {
  ...
  // num totalPenyelidikan = 0;
  String totalBanding = '';
  String bandingKorupsi = '';
  String bandingKorupsiTppu = '';
  String bandingPerpajakan = '';
  String bandingPerpajakanTppu = '';
  String bandingKapabeanan = '';
  String bandingKapabeananTppu = '';
  String bandingCukai = '';
  String bandingCukaiTppu = '';

  String totalKasasi = "";
  String kasasiKorupsi = "";
  String kasasiKorupsiTppu = "";
  String kasasiPerpajakan = "";
  String kasasiPerpajakanTppu = "";
  String kasasiKapabeanan = "";
  String kasasiKapabeananTppu = "";
  String kasasiCukai = "";
  String kasasiCukaiTppu = "";
  ...
  getData(tahun, bulanAwal, bulanAkhir) async {
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countPidsusUHukum2),
          headers: {
      ...
      if (content['status'] == 200) {
        setState(() {
          ...
          totalBanding = content['data']['bandingData']['jml_banding'];
          bandingKorupsi =
              content['data']['bandingData']['jml_banding_korupsi'];
          bandingKorupsiTppu =
              content['data']['bandingData']['jml_banding_korupsi_tppu'];
          bandingPerpajakan =
              content['data']['bandingData']['jml_banding_pajak'];
          bandingPerpajakanTppu =
              content['data']['bandingData']['jml_banding_pajak_tppu'];
          bandingKapabeanan =
              content['data']['bandingData']['jml_banding_kepabeanan'];
          bandingKapabeananTppu =
              content['data']['bandingData']['jml_banding_kepabeanan_tppu'];
          bandingCukai = content['data']['bandingData']['jml_banding_cukai'];
          bandingCukaiTppu =
              content['data']['bandingData']['jml_banding_cukai_tppu'];

          totalKasasi = content['data']['kasasiData']['jml_kasasi'];
          kasasiKorupsi = content['data']['kasasiData']['jml_kasasi_korupsi'];
          kasasiKorupsiTppu =
              content['data']['kasasiData']['jml_kasasi_korupsi_tppu'];
          kasasiPerpajakan = content['data']['kasasiData']['jml_kasasi_pajak'];
          kasasiPerpajakanTppu =
              content['data']['kasasiData']['jml_kasasi_pajak_tppu'];
          kasasiKapabeanan =
              content['data']['kasasiData']['jml_kasasi_kepabeanan'];
          kasasiKapabeananTppu =
              content['data']['kasasiData']['jml_kasasi_kepabeanan_tppu'];
          kasasiCukai = content['data']['kasasiData']['jml_kasasi_cukai'];
          kasasiCukaiTppu =
              content['data']['kasasiData']['jml_kasasi_cukai_tppu'];
        });
      } else {
    ...
    List<RoomCategoryData> roomCategories = [
      RoomCategoryData(
        ...
        roomContainers: [
          RoomContainer(
            onTap: () {},
            title: "Banding Korupsi",
            colorIcon: clrWait,
            count: bandingKorupsi,
          ),
          RoomContainer(
            onTap: () {},
            title: "Banding Korupsi TPPU",
            colorIcon: clrBadge,
            count: bandingKorupsi,
          ),
          RoomContainer(
            onTap: () {},
            title: "Banding Perpajakan",
            colorIcon: clrBadge,
            count: bandingPerpajakan,
          ),
          RoomContainer(
            onTap: () {},
            title: "Banding Perpajakan TPPU",
            colorIcon: clrBadge,
            count: bandingPerpajakanTppu,
          ),
          RoomContainer(
              onTap: () {},
              title: "Banding Kapabeanan",
              colorIcon: clrBadge,
              count: bandingKapabeanan),
          RoomContainer(
              onTap: () {},
              title: "Banding Kapabeanan TPPU",
              colorIcon: clrBadge,
              count: bandingKapabeananTppu),
          RoomContainer(
              onTap: () {},
              title: "Banding Cukai",
              colorIcon: clrBadge,
          ...
          RoomContainer(
              onTap: () {},
              title: "Banding Cukai TPPU",
              colorIcon: clrBadge,
              count: bandingCukaiTppu),
      ...
      RoomCategoryData(
        ...
        roomContainers: [
          RoomContainer(
            onTap: () {},
            title: "Kasasi Korupsi",
            colorIcon: clrWait,
            count: kasasiKorupsi,
          ),
          RoomContainer(
            onTap: () {},
            title: "Kasasi Korupsi TPPU",
            colorIcon: clrBadge,
            count: kasasiKorupsi,
          ),
          RoomContainer(
            onTap: () {},
            title: "Kasasi Perpajakan",
            colorIcon: clrBadge,
            count: kasasiPerpajakan,
          ),
          RoomContainer(
            onTap: () {},
            title: "Kasasi Perpajakan TPPU",
            colorIcon: clrBadge,
            count: kasasiPerpajakanTppu,
          ),
          RoomContainer(
              onTap: () {},
              title: "Kasasi Kapabeanan",
              colorIcon: clrBadge,
              count: kasasiKapabeanan),
          RoomContainer(
              onTap: () {},
              title: "Kasasi Kapabeanan TPPU",
              colorIcon: clrBadge,
              count: kasasiKapabeananTppu),
          RoomContainer(
              onTap: () {},
              title: "Kasasi Cukai",
              colorIcon: clrBadge,
          ...
          RoomContainer(
              onTap: () {},
              title: "Kasasi Cukai TPPU",
              colorIcon: clrBadge,
              count: kasasiCukaiTppu),
          // Add other RoomContainer objects as needed
        ],
      ),
    ];
              ...
              child: CustomButtonPrimary(
                ...
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => DetailUpayaHukumJampidsus2Page(
