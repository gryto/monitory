...
class PraPenuntutanPidsusDetail extends StatefulWidget {
  String accessToken, tahun, bulanAwal, bulanAkhir;
  PraPenuntutanPidsusDetail({
    Key? key,
  ...
  @override
  State<PraPenuntutanPidsusDetail> createState() =>
      _PraPenuntutanPidsusDetailState();
}

class _PraPenuntutanPidsusDetailState extends State<PraPenuntutanPidsusDetail> {
