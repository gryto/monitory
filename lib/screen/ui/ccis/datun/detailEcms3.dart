...
class DetailEcms3Page extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final accessToken;

  const DetailEcms3Page({
    super.key,
    required this.accessToken,
  });

  @override
  State<DetailEcms3Page> createState() => _DetailEcms3PageState();
}

class _DetailEcms3PageState extends State<DetailEcms3Page> {
  ...
  getData(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countDatunTunDetail),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          total = content['data']['permohonanBantuanHukumData'];
          total2 = content['data']['sp1BantuanHukumData'];
          total3 = content['data']['skkBantuanHukumData'];
          total4 = content['data']['skksBantuanHukumData'];
          total5 = content['data']['penyelesaianBantuanHukumData'];
          total6 = content['data']['eksekusiBantuanHukumData'];
  ...
  getData2(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunTunDetail2),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalPenyelamatan = content['data']['permohonanPelayananHukumData'];
          totalPenyelamatan2 = content['data']['sp1PelayananHukumData'];
          totalPenyelamatan3 = content['data']['sp2PelayananHukumData'];
          totalPenyelamatan4 = content['data']['penyelesaianPelayananHukumData'];
          // totalPenyelamatan5 = content['data']['penyelesaianData'];
          // totalPenyelamatan6 = content['data']['eksekusiData'];
          totalPenyelamatanAll = totalPenyelamatan + totalPenyelamatan2 + totalPenyelamatan3 + totalPenyelamatan4;
          print(total2);
        });
      } else {
        message = "Internal connection error";
  ...
  getData3(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunTunDetail3),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalTegakHukum = content['data']['permohonanPenyelenggaraPemerintahData'];
          totalTegakHukum2 = content['data']['sp1PenyelenggaraPemerintahData'];
          totalTegakHukum3 = content['data']['sp2PenyelenggaraPemerintahData'];
          totalTegakHukum4 = content['data']['penyelesaianPenyelenggaraPemerintahData'];
  ...
  getData4(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunTunDetail4),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalArbitase = content['data']['permohonanUjiMateriilMAData'];
          totalArbitase2 = content['data']['sp1UjiMateriilMAData'];
          totalArbitase3 = content['data']['sp2UjiMateriilMAData'];
          totalArbitase4 = content['data']['skkUjiMateriilMAData'];
          totalArbitase5 = content['data']['skksUjiMateriilMAData'];
          totalArbitase6 = content['data']['putusanUjiMateriilMAData'];
  ...
  getData5(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunTunDetail5),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalTermohon = content['data']['permohonanUjiMateriilMKData'];
          totalTermohon2 = content['data']['sp1UjiMateriilMKData'];
          totalTermohon3 = content['data']['sp2UjiMateriilMKData'];
          totalTermohon4 = content['data']['skkUjiMateriilMKData'];
          totalTermohon5 = content['data']['skksUjiMateriilMKData'];
          totalTermohon6 = content['data']['putusanUjiMateriilMKData'];
  ...
  Widget build(BuildContext context) {
    ...
    List<RoomCategoryData> roomCategories = [
      ...
      RoomCategoryData(
        title: "Pennyelenggara Pemerintahan",
