...
class DetailEcms4Page extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final accessToken;

  const DetailEcms4Page({
    super.key,
    required this.accessToken,
  });

  @override
  State<DetailEcms4Page> createState() => _DetailEcms4PageState();
}

class _DetailEcms4PageState extends State<DetailEcms4Page> {
  ...
  getData(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countDatunHukumDetail),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          total = content['data']['permohonanPendapatHukumData'];
          total2 = content['data']['sp1PendapatHukumData'];
          total3 = content['data']['sp2PendapatHukumData'];
          total4 = content['data']['penyelesaianPendapatHukumData'];
          // total5 = content['data']['penyelesaianPendapatHukumData'];
          // total6 = content['data']['eksekusiPendapatHukumData'];

          totalAll = total + total2 + total3 + total4;
          print(total);
        });
      } else {
        message = "Internal connection error";
  ...
  getData2(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunHukumDetail2),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalPenyelamatan = content['data']['permohonanPendampinganHukumData'];
          totalPenyelamatan2 = content['data']['sp1PendampinganHukumData'];
          totalPenyelamatan3 = content['data']['sp2PendampinganHukumData'];
          totalPenyelamatan4 = content['data']['penyelesaianPendampinganHukumData'];
  ...
  getData3(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunHukumDetail3),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalTegakHukum = content['data']['permohonanAuditHukumData'];
          totalTegakHukum2 = content['data']['sp1AuditHukumData'];
          totalTegakHukum3 = content['data']['sp2AuditHukumData'];
          totalTegakHukum4 = content['data']['penyelesaianAuditHukumData'];
  ...
  getData4(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunHukumDetail4),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalArbitase = content['data']['permohonanPelayananHukumData'];
          totalArbitase2 = content['data']['sp1PelayananHukumData'];
          totalArbitase3 = content['data']['sp2PelayananHukumData'];
          totalArbitase4 = content['data']['penyelesaianPelayananHukumData'];
          totalArbitaseAll = totalArbitase + totalArbitase2 + totalArbitase3 + totalArbitase4;
        });
      } else {
        message = "Internal connection error";
        // ignore: use_build_context_synchronously
  ...
  getData5(tahun, bulanAwal, bulanAkhir, kejati, kejari, cabang) async {
    try {
      ...
      // var params = jsonEncode({"tahun": widget.tahun});
      var response = await http.post(Uri.parse(ApiService.countDatunHukumDetail5),
          headers: {
            "Content-Type": "application/json",
            "sidac_token": widget.accessToken
          },
      ...
      if (content['status'] == 200) {
        setState(() {
          totalTermohon = content['data']['permohonanTindakanHukumLainData'];
          totalTermohon2 = content['data']['sp1TindakanHukumLainData'];
          totalTermohon3 = content['data']['sp2TindakanHukumLainData'];
          totalTermohon4 = content['data']['penyelesaianTindakanHukumLainData'];
          totalTermohonAll = totalTermohon + totalTermohon2 + totalTermohon3 + totalTermohon4;
        });
      } else {
        message = "Internal connection error";
        // ignore: use_build_context_synchronously
