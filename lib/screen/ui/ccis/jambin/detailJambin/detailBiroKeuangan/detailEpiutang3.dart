...
class DetailEpiutang3Page extends StatelessWidget {
  const DetailEpiutang3Page({super.key});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    "Dashboard Uang Pengganti Perdata dan TUN",
                    style: TextStyle(color: clrEdit, fontSize: 12),
                  ),
                ],
              ),
        ...
        child: Column(
          children: [
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        width: 8,
                                        decoration:
                                            const BoxDecoration(color: clrEdit),
                                      ),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        width: 8,
                                        decoration:
                                            const BoxDecoration(color: clrSecondary),
                                      ),
                                      const SizedBox(
                                        width: 10,
                                      ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      "Saldo awal : Rp. 6.114.865.987.507 | Mutasi tambah : Rp. 0 | Mutasi kurang : Rp. 0 | Saldo akhir : Rp. 6.114.865.987.507",
            ...
            Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(color: clrEdit),
                borderRadius: BorderRadius.circular(10),
              ),
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
