...
class DetailListSaktiPage extends StatefulWidget {
  final String accessToken, tahun, kodeProgram, kodeSatker, kodeKegiatan;
  const DetailListSaktiPage(
      {Key? key,
  ...
  @override
  State<DetailListSaktiPage> createState() => _DetailListSaktiPageState();
}

class _DetailListSaktiPageState extends State<DetailListSaktiPage> {
  late Widget body;
  ...
  searchData(idSatker, kode, kegiatan) {
    setState(() {
      isProcess = true;
      listData.clear();
    ...
    getDataLayer(dropdownValue, kodeProgram, kodeKegiatan);
  }

  getDataLayer(idSatker, kode, kegiatan) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(ApiService.countKeuanganDatatablesCasys),
          headers: {
      ...
      if (content['status'] == 200) {
        setState(() {
          listDataLayer2 = content['data']['data'];
        });
      } else {
          ...
          child: Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    "SAKTI(DETAIL KEUANGAN BERDASARKAN KODE PROGRAM)",
                    maxLines: 1,
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                searchData(
                                    dropdownValue, kodeProgram, kodeKegiatan);
                              },
                              child: Container(
            ...
            itemBuilder: (_, index) {
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  //   MaterialPageRoute(
                  //     builder: (context) => DetailDetailListSaktiPage(
                  //       accessToken: widget.accessToken,
                  //       tahun: widget.tahun,
                  //       programCode:widget.kodeProgram,
                  //       satkerCode:widget.kodeSatker,
                  //       activityCode:item['kode_kegiatan']??""
                  //     ),
                  //   ),
                  // );
                },
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text(
                          "Deskripsi Program: ${item['program'][0]['deskripsi'] ?? "-"}",
                          // textAlign: TextAlign.center,
                          style: const TextStyle(
                            fontSize: 12,
                            color: Colors.white,
                        ...
                        Text(
                          "Deskripsi Kegiatan: ${item['kegiatan'][0]['deskripsi'] ?? "-"}",
                          // textAlign: TextAlign.center,
                          style: const TextStyle(
                            fontSize: 12,
                            color: Colors.white,
                        ...
                        Text(
                          "Komponen : ${item['uraian_subkomponen'] ?? "-"}",
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
                              fontSize: 12,
