...
import 'detailListSakti.dart';

class ListSaktiPage extends StatefulWidget {
  ...
  @override
  State<ListSaktiPage> createState() => _ListSaktiPageState();
}

class _ListSaktiPageState extends State<ListSaktiPage> {
  late Widget body;
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => DetailListSaktiPage(
