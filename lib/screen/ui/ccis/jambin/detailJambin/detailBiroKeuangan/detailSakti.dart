...
import '../../../../../../src/currencyFormat.dart';
import '../../../../../../src/preference.dart';
import '../../../../../../src/toast.dart';
import '../../../constants/api.dart';
import '../../../constants/defines.dart';
import 'detailSakti/listSakti.dart';

class DetailSaktiPage extends StatefulWidget {
  final String accessToken, tahun;
  const DetailSaktiPage(
      {Key? key, required this.accessToken, required this.tahun})
      : super(key: key);

  @override
  State<DetailSaktiPage> createState() => _DetailSaktiPageState();
}

class _DetailSaktiPageState extends State<DetailSaktiPage> {
  late Widget body;
  ...
  getData(idSatker) async {
    try {
      var params = jsonEncode({"kode_satker": idSatker});
      var response = await http.post(
          Uri.parse(ApiService.countKeuanganLayer1Casys),
          headers: {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      CurrencyFormat.convertToIdr(row['total'], 2),
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        fontSize: 12,
                        color: Colors.white,
