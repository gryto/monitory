...
import 'detailBiroKepegawaian/detailSimkari.dart';
import 'detailSetJanbin.dart';

class DetailBiroKepegawaianPage extends StatefulWidget {
  final String accessToken, tahun;
  const DetailBiroKepegawaianPage(
      {Key? key, required this.accessToken, required this.tahun})
      : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _DetailBiroKepegawaianPageState createState() =>
      _DetailBiroKepegawaianPageState();
}

class _DetailBiroKepegawaianPageState extends State<DetailBiroKepegawaianPage> {
  late Widget body;
  String title = "BIRO KEPEGAWAIAN";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: biroKepegawaian()
    );
  }

  Widget biroKepegawaian() {
            ...
            onTap: () {
              if (index == 0) {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => DetailSimkariPage(
              ...
              //   Navigator.of(context).push(
              //     MaterialPageRoute(
              //       builder: (context) => const DetailSibupakPage(),
              //     ),
              //   );
              // } 
              else {
