...
import 'detailSimak/componentSimak.dart';

class DetailSimakPage extends StatefulWidget {
  final String accessToken, tahun;
  const DetailSimakPage(
      {Key? key, required this.accessToken, required this.tahun})
      : super(key: key);

  @override
  State<DetailSimakPage> createState() => _DetailSimakPageState();
}

class _DetailSimakPageState extends State<DetailSimakPage> {
  late Widget body;
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ComponentSimakPage(
                          accessToken: widget.accessToken,
                          tahun: widget.tahun,
                          kodeGolongan: row['kdgol'].toString(),
