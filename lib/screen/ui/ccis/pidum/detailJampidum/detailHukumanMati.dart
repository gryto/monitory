...
class DetailHukumanMatiPage extends StatefulWidget {
  String accessToken,  bulanAwal, bulanAkhir;
  num tahun;
  DetailHukumanMatiPage({
    Key? key,
  ...
  @override
  State<DetailHukumanMatiPage> createState() => _DetailHukumanMatiPageState();
}

class _DetailHukumanMatiPageState extends State<DetailHukumanMatiPage> {
  late Widget body;
  ...
  num totalBa17 = 0;
  num totald3 = 0;
  num totalKamnegtibum = 0;
  num totalNakortika = 0;
  num totalOrhada = 0;
  num totalTerorisme = 0;
  ...
  getData(tahun, bulanAwal, bulanAkhir) async {
    try {
      ...
      var response = await http.post(
          Uri.parse(ApiService.countPidumKategoriDetail2),
          headers: {
      ...
      if (content['status'] == 200) {
        setState(() {
          //Prapenuntutan - SPDP
          totalP48 = content['data']['eksekusiData']['jumlah_p48'];
          totalBa5 = content['data']['eksekusiData']['jumlah_ba5'];
          totalBa17 = content['data']['eksekusiData']['jumlah_ba17'];
          totald3 = content['data']['eksekusiData']['jumlah_d3'];
          totalKamnegtibum = content['data']['eksekusiData']['d3_kamnegtibum'];
          totalNakortika = content['data']['eksekusiData']['d3_narkotika'];
          totalOrhada = content['data']['eksekusiData']['d3_oharda'];
          totalTerorisme = content['data']['eksekusiData']['d3_terorisme'];
        });
      } else {
                        ...
                        child: ListView(
                          ...
                          children: [
                            RoomContainer(
                                ...
                                title: "P48",
                                colorIcon: clrWait,
                                count: totalP48.toString()),
                            RoomContainer(
                                onTap: () {},
                                title: "BA5",
                                colorIcon: clrBadge,
                                count: totalBa5.toString()),
                            RoomContainer(
                                onTap: () {},
                                title: "BA17",
                                colorIcon: clrDelete,
                                count: totalBa17.toString()),
                            RoomContainer(
                                onTap: () {},
                                title: "D3",
                                colorIcon: clrDelete,
                                count: totald3.toString()),
                          ],
                        ),
                      ),
                    ],
