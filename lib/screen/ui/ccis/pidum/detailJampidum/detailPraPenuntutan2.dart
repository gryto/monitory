...
class DetailPraPenuntutan2Page extends StatefulWidget {
  String accessToken, tahun, bulanAwal, bulanAkhir;
  DetailPraPenuntutan2Page({
    Key? key,
  ...
  @override
  State<DetailPraPenuntutan2Page> createState() =>
      _DetailPraPenuntutan2PageState();
}

class _DetailPraPenuntutan2PageState extends State<DetailPraPenuntutan2Page> {
  late Widget body;
  ...
  getData(tahun, bulanAwal, bulanAkhir, layer2, tahapan, kejati, kejari,
    ...
    try {
      ...
      var response = await http.post(Uri.parse(ApiService.countPidumDetail3),
          headers: {
      ...
      return Padding(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (_, index) {
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Janis Tindakan Pidanan : ${row['jenis_tindak_pidana']}",
                            style: const TextStyle(
                          ...
                          Text(
                            selectedListType == "p16"
                                ? "No. P16 : ${row['status_dpo'] ?? "-"}"
                                : selectedListType == "p17"
                                    ? "No. P17 : ${row['status_dpo'] ?? "-"}"
                                    : selectedListType == "p18"
                                        ? "No. P18 : ${row['status_dpo'] ?? "-"}"
                                        : selectedListType == "p19"
                                            ? "No. P19 : ${row['status_dpo'] ?? "-"}"
                                            : selectedListType == "p20"
                                                ? "No. P20 : ${row['status_dpo'] ?? "-"}"
                                                : selectedListType == "p21"
                                                    ? "No. P21 : ${row['status_dpo'] ?? "-"}"
                                                    : "No. P21a : ${row['status_dpo'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          Text(
                            selectedListType == "p16"
                                ? "Tanggal P16 : ${row['no_p16'] ?? "-"}"
                                : selectedListType == "p17"
                                    ? "Tanggal P17 : ${row['no_p17'] ?? "-"}"
                                    : selectedListType == "p18"
                                        ? "Tanggal P18 : ${row['no_p18'] ?? "-"}"
                                        : selectedListType == "p19"
                                            ? "Tanggal P19 : ${row['no_p19'] ?? "-"}"
                                            : selectedListType == "p20"
                                                ? "Tanggal P20 : ${row['no_p20'] ?? "-"}"
                                                : selectedListType == "p21"
                                                    ? "Tanggal P21 : ${row['no_p21'] ?? "-"}"
                                                    : "Tanggal P21a : ${row['no_p21a'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
              ...
              } else if (selectedListLayer2 == "tahap1") {
                return GestureDetector(
                  onTap: () {},
                  child: Container(
                    margin: const EdgeInsets.all(5.0),
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Bulan : ${row['jenis_tindak_pidana']}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                          ),
                          const SizedBox(height: 2),
                          Text(
                            "No. berkas Kembali : ${row['no_berkas_kembali'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Tanggal Terima Berkas: ${row['tgl_surat'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Jenis Pidana: ${row['nama_jenis_pidana'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Tgl. Pengantar: ${row['tgl_pengantar'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "Jenis Tindak Pidana: ${row['jenis_tindak_pidana'] ?? "-"}",
                            style: const TextStyle(
                                fontSize: 12, color: Colors.white),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
