...
class BerkasLengkapChart extends StatefulWidget {
  const BerkasLengkapChart({super.key});

  @override
  State<BerkasLengkapChart> createState() => _BerkasLengkapChartState();
}

class _BerkasLengkapChartState extends State<BerkasLengkapChart> {
