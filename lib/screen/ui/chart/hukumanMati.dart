...
class HukumanMatiChart extends StatefulWidget {
  ...
  // ignore: prefer_typing_uninitialized_variables
  final total3;
   const HukumanMatiChart({
    super.key,
    this.total1,
    this.total2,
    this.total3,
  });
  // const HukumanMatiChart({super.key});

  @override
  State<HukumanMatiChart> createState() => _HukumanMatiChartState();
}

class _HukumanMatiChartState extends State<HukumanMatiChart> {
  int value1 = 0;
  int value2 = 0;
  int value3 = 0;
  ...
  void initState() {
    ...
    setState(() {
      value1 = widget.total1;
      value2 = widget.total2;
      value3 = widget.total3;
    });
  }
    ...
    return 
      ...
      PieChart(
                PieChartData(
                  ...
                  sectionsSpace: 1,
                  centerSpaceRadius: 0,
                  sections: showingSections(value1, value2, value3),
                ),
              );
            
  }

  List<PieChartSectionData> showingSections(val1, val2, val3) {
      ...
      (i) {
        ...
        switch (i) {
          ...
          case 1:
            ...
            return PieChartSectionData(
              color: color2,
              value: val2 == 0 ? 1.0 : val3.toDouble(),
              title: 'Mahkamah Agung ($val3)',
              titleStyle: const TextStyle(
                fontSize: 10,
                color: Colors.white,
                fontWeight: FontWeight.w600,
